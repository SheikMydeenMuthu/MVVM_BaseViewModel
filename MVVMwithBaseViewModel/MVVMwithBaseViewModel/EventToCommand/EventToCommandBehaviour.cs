...
namespace MVVMwithBaseViewModel.EventToCommand
{
    public class EventToCommandBehaviour : BehaviorBase<VisualElement>
    {
        ...
        void RegisterEvent(string name)
        {
            ...
            if (eventInfo == null)
                throw new ArgumentException(string.Format("EventToCommandBehaviour: Can't register the '{0}' event.", EventName));
        ...
        void DeregisterEvent(string name)
        {
            ...
            if (eventInfo == null)
                throw new ArgumentException(string.Format("EventToCommandBehaviour: Can't de-register the '{0}' event.", EventName));
